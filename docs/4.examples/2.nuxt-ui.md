...
const patterns: PatternRule[] = [
  ...
  },
  {
    ...
    message: '❌ UPageAccordion is deprecated in v4. Use UAccordion from @nuxt/ui-pro instead.',
    replacement: 'UAccordion'
  },
  {
    regex: /v-model[.:]\w*nullify/,
    message: '❌ The "nullify" model modifier has been renamed to "nullable" in Nuxt UI v4.',
